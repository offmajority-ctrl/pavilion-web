...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Tn,depthTest:!1,depthWrite:!1})}function jc(){return new ft({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Pl(),fragmentShader:`
		...
		`,blending:Tn,depthTest:!1,depthWrite:!1})}function Qc(){return new ft({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Pl(),fragmentShader:`
...
`)+`
`+f);let b=E+m+o,M=E+f+a,N=ah(s,s.VERTEX_SHADER,b),I=ah(s,s.FRAGMENT_SHADER,M);s.attachShader(x,N),s.attachShader(x,I),t.index0AttributeName!==void 0?s.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function R(w){if(i.debug.checkShaderErrors){let G=s.getProgramInfoLog(x).trim(),z=s.getShaderInfoLog(N).trim(),X=s.getShaderInfoLog(I).trim(),$=!0,W=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if($=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,x,N,I);else{let se=ch(s,N,"vertex"),V=ch(s,I,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
