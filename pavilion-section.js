...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:En,depthTest:!1,depthWrite:!1})}function nh(){return new ct({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Dl(),fragmentShader:`
		...
		`,blending:En,depthTest:!1,depthWrite:!1})}function ih(){return new ct({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Dl(),fragmentShader:`
...
`)+`
`+f);let b=E+m+o,M=E+f+a,N=uh(s,s.VERTEX_SHADER,b),I=uh(s,s.FRAGMENT_SHADER,M);s.attachShader(x,N),s.attachShader(x,I),t.index0AttributeName!==void 0?s.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function R(A){if(i.debug.checkShaderErrors){let G=s.getProgramInfoLog(x).trim(),k=s.getShaderInfoLog(N).trim(),X=s.getShaderInfoLog(I).trim(),$=!0,W=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if($=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,x,N,I);else{let se=fh(s,N,"vertex"),V=fh(s,I,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
